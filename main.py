...
taille_ecran="grand" #taille_ecran="petit" ou taille_ecran="grand" selon la taille de l'écran.
...
Lsym_primo.append(symbole_primordial("generateur_tension",480,0))
Lsym_primo.append(symbole_primordial("generateur_counrant",480,30))
